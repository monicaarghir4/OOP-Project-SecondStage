...
public final class Constants {
    ...
    public static final String FRIEND_ERR = "Can't use ability actiontypes.on a friend";
    public static final String ENEMY_ERR = "Can't use ability actiontypes.on an enemy";
